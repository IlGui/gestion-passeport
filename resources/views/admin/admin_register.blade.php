...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{asset('panel/assets/images/drapeau2.png')}}" >
        <!--Page title-->
        ...
        <div class="preloader">
            ...
            <div class="content_wrapper">
                ...
                <div class="registration_page center_container">
                    <div class="center_content">
                        <div class="logo">
                        <div class="login-logo" style="background: #000;">
         <a style="color: red" class="navbar-brand" href="#"><span style="color: green">Mali</span><span style="color: yellow">passe</span>port</a>
                ...
                @endforeach
                        ...
                        <form action="{{route('admin.register.create')}}" method="post">
                           @csrf
                            <div class="form-group icon_parent">
                                ...
                                <input  type="text" class="form-control" name="name" value=" " required placeholder="Full Name">
                                
                                <span class="icon_soon_bottom_right"><i class="fas fa-user"></i></span>
                            </div>
                             <div class="form-group icon_parent">
                                <label for="email">E-mail</label>
                                <input  type="email" class="form-control" name="email" value=" " required  placeholder="Email Address">
                        ...
                        <div class="footer">
                            <p>Copyright &copy; 2022 MaliPasseport. Tous droits réservés.</p>
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
