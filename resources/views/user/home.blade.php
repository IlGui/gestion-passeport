...
@include('user.navbar')
    ...
    <div class="container-fluid pt-5">
        <div class="container pb-3">
            <div class="row">
                <div class="col-lg-12 col-md-9 pb-1">
                    <h4 style="color: color-primary">Demande ou renouvellement de passeport</h4>
                    Indispensable pour voyager dans la majorité des pays extérieurs , un passeport est un document d’identité et de circulation qui se présente sous la forme l’un livret sur lequel peuvent être apposés des tampons et des visas.
                    Valable pendant 5 ans , il contient dorénavant une puce électronique qui stocke des informations personnelles, dont les empreintes digitales.

                    Vous avez besoin de faire établir un passeport en vue d’un voyage ou renouveler un passeport expiré, perdu, volé ou détérioré ? Vous pouvez formuler une demande en quelques clics à l’aide du formulaire en ligne.

                    Dès le formulaire complété, nous nous chargeons de vérifier les informations saisies et de traiter votre demande. Vous recevrez ensuite un SMS ou un courriel de confirmation contenant en particulier les informations concernant votre demande et votre date de rendez-vous.
                    Un rendez-vous étant généralement indispensable, nous vous invitons à prendre contact au plus tôt avec la mairie de votre convenance.
                    En cas d’interrogations, n’hésitez pas à contacter l’un de nos conseillers par téléphone.
               </div> 
               <div class="col-lg-12 col-md-9 pb-1">
               <br><h4 style="color: color-primary">Qu'est ce que le passeport ?</h4>
                    Aujourd'hui, lors d'une demande de passeport malien, votre photo ainsi que vos empreintes sont numérisées pour être conservées dans une base de données des citoyens maliens. Le passeport est une pièce d'identité valable dans la plupart des pays étrangers. Il peut être couplé avec un visa dans certains cas particuliers (USA, France, Canada...).

                    Le passeport biométrique contient des données essentielles pour identifier le porteur, sa provenance et la validité du document :<br>
                    ...
                    - Date de délivrance et d'expiration.<br>

                    Le passeport français est délivré par la direction de la police nationale ou un consulat (à l'étranger).
               </div>
               <div class="col-lg-12 col-md-9 pb-1">
               <br><h4 style="color: color-primary">Comment faire une demande de passeport ?</h4>
                * Connectez-vous à la plateforme.<br>
                * Pour créer votre compte, cliquer sur le raccourci « Inscription ». <br>
                * Pour vous connecter à votre profil, cliquez sur le raccourci « Connexion ».<br>
                * Choisissez le cas de résidence en cliquant sur le raccourci « Demandes » puis sur « Nouvelle demande ».<br>
                * Renseignez vos informations.<br> 
                * Choisissez et validez votre moyen de paiement en payant les frais de passeport.<br>
                * Choisissez la date et le créneau horaire de votre choix pour valider votre rendez-vous.
               </div>
            </div>
        </div>
    </div>
